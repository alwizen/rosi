                 ...
                 <div class="row">
                  ...
                  <div class="col-xs-4 form-group">
                     <label>Pelanggan</label>
                        <select class="form-control toko" id="toko" name="nama_toko">
                            <?php while ($row1 = mysqli_fetch_array($result)) :; ?>

                            <option value="<?php echo $row1['id_toko']; ?>" data-price="<?php echo $row1["harga"] ?>"><?php echo $row1['nama_toko']; ?></option>
                  ...
                  <div class="col-xs-4 form-group">
                     <label>Nama Barang</label>
                        <select class="form-control item" id="item" name="nama_barang">
                            ...
                            <option value="<?php echo $row1['id_barang']; ?>" data-price="<?php echo $row1["harga"] ?>"><?php echo $row1['nama']; ?></option>
